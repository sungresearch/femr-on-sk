...
if __name__ == "__main__":
    ...
    # load model config
    model_config = read_msgpack(os.path.join(PATH_OG_MODEL, "config.msgpack"))["transformer"]
    ...
    if not os.path.exists(PATH_BATCHES):
        subprocess.run(
            [
                ...
                PATH_BATCHES, 
                "--data_path", PATH_PATIENT_DATABASE,
    ...
    if not os.path.exists(PATH_MODEL):
        ...
        cmd = [
            ...
            "--rotary_type", model_config["rotary"],
            "--weight_decay", str(args.weight_decay),
            "--internal_dropout", str(model_config["internal_dropout"]),
